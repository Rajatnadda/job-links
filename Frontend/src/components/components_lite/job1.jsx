  ...
  return (
    <div className="p-6 rounded-2xl shadow-lg bg-white border border-gray-200 cursor-pointer hover:shadow-2xl hover:shadow-blue-400 hover:p-3 duration-300 space-y-4">
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100 mt-auto">
        ...
        <Badge
          variant="outline"
          className="text-xs font-medium text-blue-600 border-blue-300 bg-emerald-50 hover:bg-emerald-100 hover:border-emerald-400 hover:shadow-sm hover:scale-105 transform transition-all duration-150"
        >
          20 LPA
        </Badge>
        <Badge
          variant="outline"
          className="text-xs font-medium text-blue-600 border-blue-300 bg-purple-50 hover:bg-purple-100 hover:border-purple-400 hover:shadow-sm hover:scale-105 transform transition-all duration-150"
        >
          Remote Job
        </Badge>
        <Badge
          variant="outline"
          className="text-xs font-medium text-blue-600 border-blue-300 bg-pink-50 hover:bg-pink-100 hover:border-pink-400 hover:shadow-sm hover:scale-105 transform transition-all duration-150"
        >
          Full Time
        </Badge>
      </div>
      <div className="flex items-center gap-4 mt-4">
        <Button
          ...
          variant="outline"
          className=" bg-gray-300 font-bold rounded-full cursor-pointer hover:bg-amber-50"
        >
          Details
        </Button>
        <Button
          variant="outline"
          className=" bg-blue-200 font-bold rounded-full cursor-pointer hover:bg-amber-50"
        >
          Save for later.
        </Button>
      </div>
