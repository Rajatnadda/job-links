...
const Privacy = () => {
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
      ...
      <p>[Your Company Name] ("us", "we", or "our") operates the [Your Job Portal Name] website (the "Service").</p>
      ...
      <ul>
        ...
        <li>To facilitate job applications and connect job seekers with employers</li>
      </ul>
      ...
      <p>[Your Company Name] will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

      <h2>4. Disclosure Of Data</h2>
      <h3>Legal Requirements</h3>
      <p>[Your Company Name] may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
