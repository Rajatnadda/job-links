...
const Privacy = () => {
  return (
    ...
    >
      ...
      <p>
        [Job Links] ("we") operates the [JobLinks] website (the " Job Finding
        Service").
      </p>
      ...
      <ul>
        ...
        <li>Resume/CV and professional history (for job seekers)</li>
      ...
      <h2>2. Use of Data</h2>
      <p>[Job Links] uses the collected data for various purposes:</p>
      <ul>
        ...
        <li>
          To facilitate job applications and connect job seekers with employers
        </li>
      </ul>
      ...
      <p>
        ...
        [Your Country] and process it there.
      </p>
      <p>
      ...
      <p>
        [Job Links] will take all steps reasonably necessary to ensure that your
      ...
      <p>
        [Job Links] may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of [Job Links]</li>
        <li>
      ...
      <ul>
        ...
        <li>By visiting this page on our website: [Job Links]</li>
